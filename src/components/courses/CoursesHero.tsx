      ...
      <div className="container mx-auto px-5 md:px-10 lg:px-[60px] relative z-10">
        <div className="hidden md:grid md:grid-cols-[1fr_0.6fr] lg:grid-cols-2 md:gap-12 lg:gap-16 items-center min-h-screen py-20">
          <div className="flex flex-col justify-center space-y-8">
            ...
            >
              Découvrez mes cours d&apos;anglais sur mesure
            </h1>
            ...
            >
              Que vous souhaitiez parler avec confiance ou préparer un entretien professionnel, chaque cours est adapté à vos besoins et objectifs.
            </p>
